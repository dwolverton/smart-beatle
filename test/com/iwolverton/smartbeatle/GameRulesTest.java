...
public class GameRulesTest {
	...
	void testEnemiesMoveWhenFrequencyExpired() {
		...
		assertEquals(new AntHill(17, 4, AntHill.DEFAULT_FREQUENCY), end.getAntHill());
